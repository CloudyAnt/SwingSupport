 ...
 * <h1>对象用setter、getter方法设置或获取每次用时（time）、刷新间隔（intervals/ms）、位置（index）</h1>
 * <hr>
 * 
 * @author 柴晓
 ...
 */
public class Fader {
	public static final int BACK_GROUND = -11, FORE_GROUND = 11, NULL = 0, NULL_BACK = 10, RETURN = 1,
			LISTEN_MouseEnter = 2, LISTEN_MousePress = 3;
	private Component c;
